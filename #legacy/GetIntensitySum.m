function [intensity, x_interpol, y_interpol] = GetIntensitySum(spectrum, p1, p2, width)
...
[x, y] = meshgrid(1:1:diagonal, (-width/2):1:(width/2));

% turning grid by the angle of the linear equation
x_interpol = round(x*cos(theta) - y*sin(theta));
y_interpol = round(x*sin(theta) + y*cos(theta));
