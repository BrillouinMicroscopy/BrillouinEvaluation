...
frequencies = linspace(0, 15e9, 100);
...
figure;
hold on
title('comparison linear and nonlinear frequency-axis')
xlabel('frequency shift')
ylabel('Error (nonlin value - lin value)')
plot(frequencies, frequencies.' - linFreq, '.')